...
# ----------------------------------------------------
video_path = r"" #Paste video path here
lane_config = {
    "model_path": r"", #Paste Lane detection model path here
    "model_type": LaneModelType.UFLDV2_CULANE, # Change to UFLDV2_CURVELANE when curved Lane
}

object_config = {
    "model_path": r'', #Paste Object Detection model path here
...
class ControlPanel(object):
    ...
    def __init__(self):
        # Load panel images
        self.collision_warning_img = cv2.resize(cv2.imread('./assets/FCWS-warning.png', cv2.IMREAD_UNCHANGED), (100, 100))
        self.collision_prompt_img = cv2.resize(cv2.imread('./assets/FCWS-prompt.png', cv2.IMREAD_UNCHANGED), (100, 100))
        self.collision_normal_img = cv2.resize(cv2.imread('./assets/FCWS-normal.png', cv2.IMREAD_UNCHANGED), (100, 100))
        self.left_curve_img = cv2.resize(cv2.imread('./assets/left_turn.png', cv2.IMREAD_UNCHANGED), (200, 200))
        self.right_curve_img = cv2.resize(cv2.imread('./assets/right_turn.png', cv2.IMREAD_UNCHANGED), (200, 200))
        self.keep_straight_img = cv2.resize(cv2.imread('./assets/straight.png', cv2.IMREAD_UNCHANGED), (200, 200))
        self.determined_img = cv2.resize(cv2.imread('./assets/warn.png', cv2.IMREAD_UNCHANGED), (200, 200))
        self.left_lanes_img = cv2.resize(cv2.imread('./assets/LTA-left_lanes.png', cv2.IMREAD_UNCHANGED), (300, 200))
        self.right_lanes_img = cv2.resize(cv2.imread('./assets/LTA-right_lanes.png', cv2.IMREAD_UNCHANGED), (300, 200))
